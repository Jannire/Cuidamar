        ...
        <div className='container mt-5'>
            ...
            <div className='row'>
                ...
                <div className='col-4' id='contenedorR'>
                    ...
                    <input type="text" class="form-control mt-3" placeholder="Username" value={Username}
                    ...
                    <input type="text" class="form-control mt-3" placeholder="Nombre" value={Nombre}
                        onChange={(evt) => { setNombre(evt.target.value) }} />

                    <input type="text" class="form-control mt-3" placeholder="Apellido Paterno" value={Apellido_Paterno}
                        onChange={(evt) => { setApellido_Paterno(evt.target.value) }} />

                    <input type="text" class="form-control mt-3" placeholder="Apellido Materno" value={Apellido_Materno}
