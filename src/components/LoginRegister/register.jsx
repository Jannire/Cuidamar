    ...
    return <div> 
        ...
        <div className='container mt-5'>
            ...
            <div  className='col-4'   id='contenedorR'>
                ...
                <input type="text" class="form-control mt-3" id="floatingInput" placeholder="Username" value={Username}
                ...
                <input type="text" class="form-control mt-3" id="floatingInput" placeholder="Nombre" value={Nombre}
                onChange={(evt)=>{setNombre(evt.target.value)}}/>
               
                <input type="text" class="form-control mt-3" id="floatingInput" placeholder="Apellido Paterno" value={Apellido_Paterno}
                onChange={(evt)=>{setApellido_Paterno(evt.target.value)}}/>

                <input type="text" class="form-control mt-3" id="floatingInput" placeholder="Apellido Materno" value={Apellido_Materno}
                onChange={(evt)=>{setApellido_Materno(evt.target.value)}}/>


                
                <div class="d-grid gap-2">
                    <button id='botonLogin' class="btn btn-primary mt-3 mb-3" type="button" 
                    onClick={
                        ()=>{
